...
(function (nomnoml) {
    ...
    function parseAndRender(code, graphics, canvas, scale, xxx, yyy) {
    ...
    function draw(canvas, code, scale, xxx, yyy) {
        return parseAndRender(code, nomnoml.skanaar.Canvas(canvas), canvas, scale || 1, xxx, yyy);
    }
    nomnoml.draw = draw;
...
var nomnoml;
(function (nomnoml) {
    function render(graphics, config, compartment, setFont, xxx, yyy) {
